...
-- CTA Submissions Policies
-- Only authenticated admin users can read
CREATE POLICY "Admin users can view CTA submissions"
  ON cta_submissions
  FOR SELECT
  TO authenticated
  USING (
...
-- Admins can delete
CREATE POLICY "Admin users can delete CTA submissions"
  ON cta_submissions
  FOR DELETE
  TO authenticated
  USING (
...
SELECT set_admin_emails('admin@z21.ai,troy@z21.ai');
